...
def summarize_run(csv_path, scenario=DEFAULT_SCENARIO):
    ...
    if metadata_path.exists():
        ...
        for key in (
            ...
            "cluster_split_min_subcluster_size",
            "cluster_split_budget_fraction",
...
def _fieldnames(rows):
    ...
    priority = [
        ...
        "final_member_stale_ch_no_attempt_fraction",
        "final_member_stale_ch_compute_failure_fraction",
        "final_member_stale_ch_energy_failure_fraction",
        "final_member_stale_ch_access_no_draw_fraction",
        "final_member_stale_ch_not_scheduled_fraction",
        "final_member_stale_ch_other_no_attempt_fraction",
        "csv_path",
    ]
    seen = set()
    ordered = []
